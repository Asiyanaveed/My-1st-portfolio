...
function AboutSection() {
  return (
    <>
      <section id='about' className='w-full py-[160px] px-10 bg-[#7a7a7ac5] flex flex-col md:flex-row justify-center'>
        
        <div className='mx-auto w-[50%] px-[16px] flex flex-col items-start text-left'>
          <p className={`${caveat.className} text-[48px] text-[#a00606c5]`}>Asiya Naveed</p>
          
          <p className={`${caveat.className} text-[30px] mt-2 mb-6 text-light-beige text-center lg:text-start text-3xl text-[#6b6668c5]`}>Freelance Web Developer</p>
