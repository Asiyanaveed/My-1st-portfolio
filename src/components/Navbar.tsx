    ...
    <div className='sticky top-0'>
      <header className='relative w-full h-auto p-[1.5rem_1rem_1.5rem_1rem] bg-[#0a0908] shadow-sm shadow-[#251e16]'>
        <nav className='h-[2.25rem] mx-[1.6875rem] flex justify-between'>
          <div>
            <Link href='/'><p className={`${caveat.className} text-[1.875rem] font-semibold text-[#6b6668c5]`} ><span className='text-[#a00606c5]'>A</span>siya <span className='text-[#a00606c5]'>N</span>aveed</p></Link>
          </div>
